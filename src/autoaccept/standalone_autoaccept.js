function buildStandaloneObserverScript(buttonTexts, blockedCommands, allowedCommands) {
    return `
(function() {
    ...
    function scanAndClick() {
        ...
        var groups = Array.from(document.querySelectorAll('[role="radiogroup"], fieldset, div.flex-col'));
...
module.exports = { buildStandaloneObserverScript };
